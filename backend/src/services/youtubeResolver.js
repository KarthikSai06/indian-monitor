...
const CHANNELS = [
  ...
  { handle: 'News18AssamNortheastLive', name: 'News18 Assam Northeast Live', state: 'Assam', lang: 'Assamese', icon: '📺', color: '#2e7d32' },
  ...
  { handle: 'TV9TeluguLive', name: 'TV9 Telugu', state: 'Andhra Pradesh', lang: 'Telugu', icon: '📺', color: '#4a148c' },
  ...
  { handle: 'sianetSuvarnaNews', name: 'Suvarna News', state: 'Karnataka', lang: 'Kannada', icon: '📡', color: '#f57f17' },
];
